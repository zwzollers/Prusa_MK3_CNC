...
#define STRING_CONFIG_H_AUTHOR "(Prussia3D, Paul_GD/zwzollers MK3S)" // Original author or contributor.
...
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT { 100, 100, 3200/8}
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 12}
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 960, 960, 200}
